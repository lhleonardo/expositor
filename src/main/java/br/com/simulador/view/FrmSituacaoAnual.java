...
public class FrmSituacaoAnual extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		btnLimparCampos.addActionListener(evt -> resetFields());

		javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
		layout.setHorizontalGroup(layout.createParallelGroup(Alignment.LEADING)
		        .addGroup(layout.createSequentialGroup().addGroup(layout.createParallelGroup(Alignment.LEADING)
		                .addGroup(layout.createSequentialGroup().addGap(82)
		                        .addGroup(layout.createParallelGroup(Alignment.TRAILING, false)
		                                .addGroup(layout.createSequentialGroup().addComponent(jLabel1)
		                                        .addPreferredGap(ComponentPlacement.RELATED)
		                                        .addComponent(txtPrimeiroB, GroupLayout.PREFERRED_SIZE, 80,
		                                                GroupLayout.PREFERRED_SIZE)
		                                        .addGap(34).addComponent(jLabel2)
		                                        .addPreferredGap(ComponentPlacement.RELATED).addComponent(txtSegundoB,
		                                                GroupLayout.PREFERRED_SIZE, 80, GroupLayout.PREFERRED_SIZE))
		                        .addGroup(Alignment.LEADING, layout.createSequentialGroup()
		                                .addGroup(layout.createParallelGroup(Alignment.TRAILING)
		                                        .addComponent(btnCalcular, GroupLayout.PREFERRED_SIZE, 152,
		                                                GroupLayout.PREFERRED_SIZE)
		                                .addGroup(layout.createSequentialGroup().addComponent(jLabel3)
		                                        .addPreferredGap(ComponentPlacement.RELATED).addComponent(txtTerceiroB,
		                                                GroupLayout.PREFERRED_SIZE, 80, GroupLayout.PREFERRED_SIZE)))
		                                .addGap(18)
		                                .addGroup(layout.createParallelGroup(Alignment.TRAILING)
		                                        .addGroup(layout.createSequentialGroup().addComponent(jLabel4)
		                                                .addPreferredGap(ComponentPlacement.RELATED)
		                                                .addComponent(txtQuartoB, GroupLayout.PREFERRED_SIZE, 80,
		                                                        GroupLayout.PREFERRED_SIZE))
		                                        .addComponent(btnLimparCampos, GroupLayout.DEFAULT_SIZE, 171,
		                                                Short.MAX_VALUE)))))
		...
		layout.setVerticalGroup(layout.createParallelGroup(Alignment.LEADING)
		        .addGroup(layout.createSequentialGroup().addGap(31)
		                .addGroup(layout.createParallelGroup(Alignment.BASELINE)
		                        .addComponent(txtPrimeiroB, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
		                                GroupLayout.PREFERRED_SIZE)
		                .addComponent(jLabel1)
		                .addComponent(txtSegundoB, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
		                        GroupLayout.PREFERRED_SIZE).addComponent(jLabel2))
		        .addGap(29)
		        .addGroup(layout.createParallelGroup(Alignment.BASELINE)
		                .addComponent(txtTerceiroB, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
		                        GroupLayout.PREFERRED_SIZE)
		                .addComponent(jLabel3)
		                .addComponent(txtQuartoB, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
		                        GroupLayout.PREFERRED_SIZE)
		        ...
		        .addPreferredGap(ComponentPlacement.RELATED, 26, Short.MAX_VALUE).addComponent(jLabel5)
		        .addPreferredGap(ComponentPlacement.RELATED)
		        .addComponent(jScrollPane1, GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE).addContainerGap()));
	...
	private boolean preenchimentoCorreto() {
		return ((campoPreenchido(txtPrimeiroB) && 
				campoPreenchido(txtSegundoB) && 
				campoPreenchido(txtTerceiroB)) ||
	...
	private String montaBuilder(Calculadora calculadora) {
		...
		String situacao = calculadora.isAprovado() ? 
				"APROVADO" : txtQuartoB.getText().isEmpty() ? 
						     "EM ANDAMENTO" : "REPROVADO";
		
		builder.append("\nSituação: " + situacao);
		
		if (!calculadora.isAprovado()) {
			builder.append("\nValor necessário para aprovação: " + 
							calculadora.getValorNecessario());
		}
